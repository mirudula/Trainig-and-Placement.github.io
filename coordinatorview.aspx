<%@ Page Title="" Language="C#" MasterPageFile="~/Coordinator.master" AutoEventWireup="true" CodeFile="coordinatorview.aspx.cs" Inherits="coordinatorview" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1><creatr>View Company Details</creatr></h1>
   <table>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <asp:Panel ID="Panel1" runat="server" Visible="false" Height="181px" 
                Width="281px">
                <br />
                <table bgcolor="#99CCFF" style="height: 143px; width: 259px">
                    <tr>
                        <td>
