<%@ Page Title="" Language="C#" MasterPageFile="~/Coordinator.master" AutoEventWireup="true" CodeFile="coordiviewperformance.aspx.cs" Inherits="coordiviewperformance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1><creatr>View Test Performance</creatr></h1>
 <table>
        <tr>
            <td>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False" Height="309px" Width="644px">
        <table>
            <tr>
                <td>
                     <table style="height: 247px; width: 340px">
           <tr>
               <td>
        ...
        <tr>
         ...
         <tr>
            ...
            &nbsp;/ 20</td>
                  ...
                  <td>
                    <asp:Chart ID="Chart1" runat="server" BackColor="LavenderBlush" DataSourceID="AccessDataSource2" Height="258px" Palette="Berry" Width="273px">
                        <Series>
