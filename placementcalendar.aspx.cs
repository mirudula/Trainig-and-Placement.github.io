...
public partial class placementcalendaraspx : System.Web.UI.Page
{
    OleDbConnection con;
    OleDbCommand cmd;
    ...
    {
        lblregno.Text = Session["stu"].ToString();
        data();
        query = "select Studentname,Dept from studet where Regno='" + lblregno.Text + "'";
